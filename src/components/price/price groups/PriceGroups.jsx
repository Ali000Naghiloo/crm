...
import CreatePriceGroup from "./create group/CreateGroup";
import GroupModal from "./group data/GroupModal";
...
export default function Groups() {
  ...
  // const CreatePriceGroup = lazy(() => import("./create product/CreatePriceGroup"));
  ...
  const columns = [
    ...
    {
      title: "عنوان گروه",
      dataIndex: "pricingMethodGroupTitle",
      key: "pricingMethodGroupTitle",
    },
    {
      title: "توضیحات گروه",
  ...
  const handleGetList = async () => {
    ...
    await httpService
      ...
      .then((res) => {
        if (res.status === 200 && res.data?.code === 1) {
          let datas = [];
          res.data.pricingMethodGroupViewModelList.map((data, index) => {
